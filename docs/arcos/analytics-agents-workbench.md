...
| **F10.2b.2 — I/O real do cliente (`collect`)** | `skill_survey_v1` usa `collect` para perguntar o NPS ao cliente e alimenta `survey_record` com a resposta (substitui o valor semeado). | E2E com resposta real do cliente |
