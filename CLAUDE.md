...
### Detach de hooks de finalização + Pull direcionado + ACW *(desenho fechado 2026-07-23; Camadas A ✅ + B ✅ + C ✅ + D ✅ 2026-07-24; E1 ✅ (Forma A aposentada); E2 wrap-up detached ✅ (gravação + wiring on_human_end, 2026-07-24/27) — falta só `acw_pending` (E2e) + isenção métricas (E2f); F validação)*
