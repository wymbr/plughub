...
# Journey formatters — REMOVED (Arc 19 Fase F)
# fmt_journey_active_count, fmt_journey_resolution_rate, fmt_journey_funnel,
# fmt_journey_median_duration and their sync helpers removed.
