"""
test_ret15_tarefas_efemeras.py — RET-15: a tarefa efêmera tem dono e tem alarme.
...
from plughub_channel_gateway import tarefas
...
class TestOsCallSites:
    ...
    def test_o_adapter_usa_o_helper_do_pacote(self, modulo: str):
        ...
        assert getattr(m, "disparar", None) is tarefas.disparar, (
