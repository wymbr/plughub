/**
 * AnaliseJourneysPage — REMOVED (Arc 19 Fase F)
 *
...
export const AnaliseJourneysPage: React.FC = () => <Navigate to="/analise/sessions" replace />;

export default AnaliseJourneysPage;
