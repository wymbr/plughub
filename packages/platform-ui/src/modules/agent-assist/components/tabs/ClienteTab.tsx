...
import { User, Search, UserPlus, Check, AlertCircle, Star, MessageSquareHeart, Phone } from "lucide-react";
...
const Customer360Card: React.FC<{ customerId: string }> = ({ customerId }) => {
