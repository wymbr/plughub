    ...
    <div>
      ...
      >
        <div className="space-y-5">
          ...
          <div>
            <Select
              label={t('pools.purpose.label')}
              value={formData.purpose}
              onChange={e => setFormData({ ...formData, purpose: e.target.value as 'contact' | 'internal' })}
              options={[
                { value: 'contact',  label: t('pools.purpose.contact') },
                { value: 'internal', label: t('pools.purpose.internal') },
              ]}
            />
