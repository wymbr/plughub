...
**PID-01, PID-02, PID-03, PID-07, PID-06, PID-13, PID-15 e PID-08 fechadas** — a pendência com exigência só é liberada e só é retomada por quem provou nesta sessão (ou por principal humano verificado), em todas as portas. **PID-10 depende de IDN-07.** A migração dos dois intakes (PID-04) vem
