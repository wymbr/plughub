...
|---|---|---|---|
| MOD-06 | **G5 — cortes #2 e #3** (DESBLOQUEADA: a MOD-05 fechou em 2026-09-08): `workflows.operacao` (Editor x Monitor) e `config.resources` (Pools x Skills) | `aberto` | ADR D6 #2/#3 |
