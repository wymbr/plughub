...
| OUT-04 | Pacing `look_ahead` para o discador de voz | `bloqueado` por `VOZ-05` — depende do plano de mídia E do bot leg: o ADR §7 põe o discador depois do V-F2. | idem · bloqueador trocado em 2026-09-14: o SFU (V-F0) subiu, e SFU sozinho não disca |
